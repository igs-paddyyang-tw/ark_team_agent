...
[![Version](https://img.shields.io/badge/version-1.6.9-orange)](https://github.com/igs-paddyyang-tw/ark_team_agent/releases)
...
```bash
pip install https://github.com/igs-paddyyang-tw/ark_team_agent/releases/download/v1.6.9/ark_team_agent-1.6.9-py3-none-any.whl
```
