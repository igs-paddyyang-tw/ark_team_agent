...
[![Version](https://img.shields.io/badge/version-1.7.30-orange)](https://github.com/igs-paddyyang-tw/ark_team_agent/releases)
...
```bash
pip install https://github.com/igs-paddyyang-tw/ark_team_agent/releases/download/v1.7.30/ark_team_agent-1.7.30-py3-none-any.whl
```
