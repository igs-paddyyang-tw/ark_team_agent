...
[![Version](https://img.shields.io/badge/version-1.8.4-orange)](https://github.com/igs-paddyyang-tw/ark_team_agent/releases)
...
```bash
pip install https://github.com/igs-paddyyang-tw/ark_team_agent/releases/download/v1.8.4/ark_team_agent-1.8.4-py3-none-any.whl
```
