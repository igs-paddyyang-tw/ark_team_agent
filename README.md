...
[![Version](https://img.shields.io/badge/version-1.7.6-orange)](https://github.com/igs-paddyyang-tw/ark_team_agent/releases)
...
```bash
pip install https://github.com/igs-paddyyang-tw/ark_team_agent/releases/download/v1.7.6/ark_team_agent-1.7.6-py3-none-any.whl
```
